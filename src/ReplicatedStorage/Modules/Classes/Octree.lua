...
local OCTANT_MAP = {
	{
		{
			OCTANTS.LeftBottomBack,
			OCTANTS.LeftBottomFront
		},
		{
			OCTANTS.LeftTopBack,
			OCTANTS.LeftTopFront
		}
	},
	{
		{
			OCTANTS.RightBottomBack,
			OCTANTS.RightBottomFront
		},
		{
			OCTANTS.RightTopBack,
			OCTANTS.RightTopFront
		}
	}
}
...
-- // OctreeLeaf // --
local OctreeLeaf = {ClassName = 'OctreeLeaf'}
...
function Octree:GetNearestNeighbor(coordinate, max_dist)
	...
	local best, _ = recursiveNN(self, coordinate, nil, math.huge)
